    (function ( $ ) {
        ...
        $.fn.matrixchart = function(options) {
            ...
            for (var i=1;i<=settings.noOfxLevels; i++){
                var ImageLink = '<img src="img/H'+i+'.jpg">'
                xlevelColor =  HSVtoRGB; //(initialStarth + ((i-1) * xcolordivision),HSVsValue,HSVvValue);
                xlevelpoints += '<div class="axis-point-level level-'+i+'" style="width:'+xcellsize+'%"><span style="background: rgb('+xlevelColor[0]+','+xlevelColor[1]+','+xlevelColor[2]+')">'+ImageLink+'</span><p>'+settings.xlabels[i-1]+'</p></div>';
            }
            ...
            for (var i=1;i<=settings.noOfyLevels; i++){
                ...
                ylevelpoints += '<div class="axis-point-level level-'+i+'" style="height:'+ycellsize+'%"><span style="background: rgb('+ylevelColor[0]+','+ylevelColor[1]+','+ylevelColor[2]+')">'+ImageLink+'</span><p>'+settings.ylabels[i-1]+'</p></div>';                
            }
